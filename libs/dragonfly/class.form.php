...
class Form {
    ...
    public function addField($type, $id,$label,$mandatory=false, $init_value=false, $aux=false) {
        $allowed=Array("text", "textarea", "radio", "checkbox", "select", "file", 
                ...
                if ($type) {
                    if (($type=="auxtext")||($type=="auxitem")) {
                        ...
                        switch ($type) {
                            ...
                            case "search":
                            case "tel":
                            case "hidden": $this->inputfield($id, $mandatory, $init_value, $aux, $type, $label);
                                break;
                            case "password": $this->passwordfield($id, $mandatory, $init_value, $aux, $label);
                                break;
                            case "file": $this->filefield($id, $mandatory, $aux,$label);
                                break;
                            case "textarea": $this->textarea($id, $mandatory, $init_value, $aux,$label);
                                break;
